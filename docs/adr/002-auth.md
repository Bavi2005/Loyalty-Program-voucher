...
**Consequences.** Simple to reason about; no server session state. Refresh tokens were intentionally omitted (scope/valence) — tokens are short-lived (`JWT_EXPIRES_IN`, default 12h).
